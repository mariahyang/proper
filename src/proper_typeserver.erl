...
-type substs_dict() :: dict:dict(). %% dict(field_name(),ret_type())
...
%% @private_type
-type mod_exp_types() :: sets:set(). %% set(imm_type_ref())
-type mod_types() :: dict:dict(). %% dict(type_ref(),type_repr())
%% @private_type
-type mod_exp_funs() :: sets:set(). %% set(fun_ref())
-type mod_specs() :: dict:dict(). %% dict(fun_ref(),fun_repr())
-record(state,
...
-type var_dict() :: dict:dict(). %% dict(var_name(),ret_type())
%% @private_type
...
-spec update_vars(abs_type(), dict:dict(), boolean()) -> abs_type().
